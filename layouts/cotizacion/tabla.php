    ...
    <div class='modal-dialog'>
                <div class='modal-content'>
                    ...
                    <div class='modal-body form'>
                       <form action='#' class='form-horizontal form-row-seperated' id='form_buscar'>
                           <div class='form-group'  >
                               ...
                               <div class="col-md-6">
                                     <select id="my_multi_select1" multiple>
                    ...
                    <div class='modal-footer'>
                        <button type='button' class='btn btn-primary' data-facturacion-tipo="accion" data-facturacion-accion="cancelarduplicarmuestras" ><i class='fa fa-check' ></i>Cancelar</button>
                        <button type='button' class='btn btn-primary' data-facturacion-tipo="accion" data-facturacion-accion="duplicarmuestras" id='bt_form_duplicar_duplicar'><i class='fa fa-check' ></i>Duplicar</button>
                    </div>
                </div>
           </div>
    </div>
